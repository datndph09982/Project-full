...
const sortprice2 ={
    async render(){
        const {data:products} =await ProductApi.getSort2();
        return `
        ${await menuList.render()}
        <div class=" col-span-4 bg-gray-100 py-4">
            <h2 class="not-italic text-4xl font-sans font-medium text-center mb-4">Price: high to low</h2>
